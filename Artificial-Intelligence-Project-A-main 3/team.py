    ...
    "team_members": [
        {
            ...
            "student_id": "1302055",
            "email": "ngochuyn@student.unimelb.edu.au" # Must be @student.unimelb.edu.au address
        },
        {
            "name": "Ngoc Duy Tran",
            "student_id": "1156724",
            "email": "ngocduyt@student.unimelb.edu.au" # Must be @student.unimelb.edu.au address
        }
    ],
}
